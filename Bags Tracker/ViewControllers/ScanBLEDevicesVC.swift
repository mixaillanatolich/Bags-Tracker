...
class ScanBLEDevicesVC: UIViewController {
    ...
    @IBAction func addByIdButtonClicked(_ sender: Any) {
        self.performSegue(withIdentifier: "ShowSearchBeaconsByIdScreen", sender: nil)
    }
    
}

extension ScanBLEDevicesVC: UITableViewDelegate, UITableViewDataSource {
